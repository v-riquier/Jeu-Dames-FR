...
void JoueurC::HumainTour(TableJeu &table_jeu)
{
	...
	while (cmpt < table_jeu.joueurs.at(1).pions.size())
	{
		...
		if (table_jeu.joueurs.at(1).pions.at(cmpt).selectionne == true && table_jeu.joueurs.at(1).pions.at(cmpt).type_pion == dame_B)
		{
			pion_selec = true;
			pion_type = 3;
		}
...
bool JoueurC::ia_selectionPionAJouer(TableJeu &table_jeu)
{
	...
	while (compt < table_jeu.joueurs.at(0).pions.size())
	{
		...
		if (table_jeu.joueurs.at(0).pions.at(compt).type_pion == dame_N)
		{
			bool m_haut_g = false;
			bool m_haut_d = false;
			bool m_bas_g = false;
	...
	if (!poss_deplacem_simple)
	{
		...
		while (compt2 < table_jeu.joueurs.at(0).pions.size())
		{
			...
			if (table_jeu.joueurs.at(0).pions.at(compt2).type_pion == dame_N)
			{
				bool m_haut_g = false;
				bool m_haut_d = false;
				bool m_bas_g = false;
...
void JoueurC::CPU_Tour(TableJeu &table_jeu)
{
	...
	if (ia_selectionPionAJouer(table_jeu))
	{
		...
		while (cmpt < table_jeu.joueurs.at(0).pions.size())
		{
			...
			if (table_jeu.joueurs.at(0).pions.at(cmpt).selectionne == true && table_jeu.joueurs.at(0).pions.at(cmpt).type_pion == dame_N)
			{
				pion_type = 2;
			}
			cmpt++;
...
bool JoueurC::JeuPossibleSimplePion(TableJeu &table_jeu)
{
	...
	while (cmpt < table_jeu.joueurs.at(1).pions.size())
	{
		if (table_jeu.joueurs.at(1).pions.at(cmpt).selectionne == true)
		{
			...
			if (!poss_cap)
			{
				if (espace_vide && (((sourisX / 75 == indic_pos_x - 1) && (sourisY / 75 == indic_pos_y - 1)) || ((sourisX / 75 == indic_pos_x + 1) && (sourisY / 75 == indic_pos_y - 1) && (sourisX / 75 < 10))))
				{
					possible = true;
				}
			}
...
bool JoueurC::JeuPossibleDame(TableJeu &table_jeu)
{
	...
	while (cmpt < table_jeu.joueurs.at(1).pions.size())
	{
		if (table_jeu.joueurs.at(1).pions.at(cmpt).selectionne == true)
		{
			...
			while (compt < table_jeu.joueurs.at(1).pions.size())
			{
				if (table_jeu.joueurs.at(1).pions.at(compt).selectionne && table_jeu.joueurs.at(1).pions.at(compt).type_pion == dame_B)
				{
					bool m_haut_g = false;
					bool m_haut_d = false;
					bool m_bas_g = false;
			...
			if (!poss_cap)
			{
				if (espace_vide && (((sourisX / 75 == indic_pos_x - 1) && (sourisY / 75 == indic_pos_y - 1)) || ((sourisX / 75 == indic_pos_x + 1) && (sourisY / 75 == indic_pos_y - 1) && (sourisX / 75 < 10)) || ((sourisX / 75 == indic_pos_x - 1) && (sourisY / 75 == indic_pos_y + 1)) || ((sourisX / 75 == indic_pos_x + 1) && (sourisY / 75 == indic_pos_y + 1) && (sourisX / 75 < 10))))
				{
					possible = true;
				}
			}
...
bool JoueurC::ia_PossibiliteCapture(TableJeu &table_jeu)
{
	...
	while (compt < table_jeu.joueurs.size())
	{
		...
		while (compt2 < table_jeu.joueurs.at(compt).pions.size())
		{
			...
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == dame_B)
			{
				if (table_jeu.joueurs.at(compt).pions.at(compt2).selectionne == true)
				{
					tableau_virtuel[posx][posy] = 1;
			...
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == dame_N)
			{
				if (table_jeu.joueurs.at(compt).pions.at(compt2).selectionne == true)
				{
					tableau_virtuel[posx][posy] = 1;
		...
		while (compteur3 < 10)
		{
			...
			while (compteur4 < 10)
			{
				...
				if (tableau_virtuel[compteur3][compteur4] == val_a_verif)
				{
					...
					if (!dir_b_g && compteur3 > 1 && compteur4 < 8)
					{
					...
					if (!dir_b_d && compteur3 < 8 && compteur4 < 8)
					{
						if (tableau_virtuel[compteur3 + 1][compteur4 + 1] == -1 && tableau_virtuel[compteur3 + 2][compteur4 + 2] > -1 && tableau_virtuel[compteur3 + 2][compteur4 + 2] < val_a_verif + 1)
						{
							dir_b_d = true;
	...
	while (compt < table_jeu.joueurs.size())
	{
		...
		while (compt2 < table_jeu.joueurs.at(compt).pions.size())
		{
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == pion_B)
			{
				...
				{
					table_jeu.joueurs.at(compt).pions.at(compt2).type_pion = dame_B;
				}
			}
			...
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == pion_N)
			{
				...
				{
					table_jeu.joueurs.at(compt).pions.at(compt2).type_pion = dame_N;
				}
			}
